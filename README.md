    ...
    <table>
            ...
            <table>
                ...
                <tr>
                    <td valign="top" width="50%">
                        <h3>Flexible Positions to Display Attachments</h3>
                        <ul>
                            <li>On product pages:</li>
                            <ul>
                                <li>In product tab</li>
                                <li>Under Add To Cart button</li>
                            </ul>
                            <li>On order view page</li>
                            <li>In order confirmation email</li>
                        </ul>
                        <br/>
                        <h3>General Configuration</h3>
                        <ul>
                            <li>Show/Hide file icon, description, category, size, download number</li>
                            <li>Specify file formats allowed to upload</li>
                            <li>Set maximum file size allowed to upload</li>
                        </ul>
                        <br/>
                        <h3>Attachment Management</h3>
                        <ul>
                            <li>Upload unlimited files of any type</li>
                            <li>Manage all uploaded attachments in a grid</li>
                            <li>2 ways to add attachments:</li>
                            <ul>
                                <li>Upload files with drag & drop supported</li>
                                <li>Attach URLs</li>
                            </ul>
                            <li>Add file name, label and description</li>
                            <li>Assign an attachment to a specific category</li>
                            <li>Display attachments to certain customer groups and store views</li>
                            <li>Set attachment download limit</li>
                            <li>Auto-identify attachment format</li>
                            <li>Assign an attachment to product pages using conditions</li>
                            <li>Preview assigned products</li>
                        </ul>
                    </td>
                    <td valign="top">
                        <br/>
                        ...
                        <ul>
                            <li>Manage all icons in a grid</li>
                            <li>Upload unlimited icons</li>
                            <li>Assign an icon to multiple file formats</li>
                        </ul>
                        <h3>Category Management</h3>
                        <ul>
                            <li>Manage all categories in a grid</li>
                            <li>Create unlimited attachment categories</li>
                        </ul>
                        <br/>
                        <h3>Advanced Configuration</h3>
                        <ul>
                            <li>Bulk import attachments via CSV</li>
                            <li>API support</li>
                        </ul>
                        <br/>
                        <h3>Others</h3>
        ...
        <tr>
            ...
            <div>
                ...
                <p>Please note that the maximum allowed size for uploaded files depends on your server. If you don't specify a max allowed file size or enter a number that is greater than the server limitation, then server limitation will be applied.</p>
            </div>
            <div>
                <strong>Can I limit the number of times an attachment can be downloaded?</strong>
                <p>Yes, you can set a download limit for an attachment to prevent excessive downloads.</p>
            </div>
            <div>
                <strong>Can I show attachments to certain customer groups or on specific store views? </strong>
                <p>Yes, of course.</p>
            </div>
            <div>
                <strong>Can I assign an icon to multiple file types?</strong>
                <p>Yes, you can.</p>
            </div>
            <div>
                <strong>What if I upload a file whose format hasn’t been assigned to any icon? </strong>
                <p>If an uploaded file type hasn’t been assigned to any icon, then it will be displayed with a default icon that we previously set.</p>
                <p>However, you can upload your own icon and set it as default to replace ours.</p>
            </div>
            <div>
                <strong>If I attach a file using URLs, will the file be automatically assigned to an icon?</strong>
                <p>Yes, our extension will automatically detect the file URL and assign it to the relevant icon. If the file URL can’t be detected, it will be assigned to our default icon or the default one you set.</p>
            </div>
            <div>
                <strong>How can I assign an attachment to specific product pages?</strong>
                <p>When you upload an attachment, you can specify which product pages to display it using conditions.</p>
            </div>
            <h3>Support FAQs</h3>
            <div>
                <strong>How can I get installation support?</strong>
                <p>When you are buying our product, you can see the information of it in add to cart area. In the 'Additional Services' block, tick on 'Free Installation Support' before adding to cart. Just submit a ticket here and we're ready for help within 24 hours. This service is totally free, all the thing you have to do is providing us with those below information:
                    <br/> - Order ID
                    <br/> - SSH account & admin account</p>
            </div>
            <div>
            ...
            <div>
                ...
                <ul>
                    ...
                    <li>Contact us via live chat on our website.</li>
                </ul>
            </div>
            <h3>Payment FAQs</h3>
            <div>
